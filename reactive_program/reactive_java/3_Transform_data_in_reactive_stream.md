...
Note:-
 - Pom.xml is same as the exemple with [failFast and failSilent](https://github.com/thirumurthis/Learnings/blob/master/reactive_program/reactive_java/SimpleReactive_failFast_failSilent_approach.md)
