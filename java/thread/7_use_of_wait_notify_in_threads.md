...
class Processor{
  ...
  public void produce() throws InterruptedException{
     ...
     synchronized (this){ 
       ...
       System.out.println("resumsed....from wait");
     }
  }
  ...
  public void consume() throws InterruptedException{
     ...
     synchronized(this){
        ...
        // the sleep makes the object locked for 3 seconds, the notify() will not immediately
        // awake or start the wait thread since that is also part of the sync block
        // for 3000 second the internsic/monitor lock is acquired.
        System.out.println("Object awake after 3 seconds");
     }
  }
}
```
